...
// Idempotent — safe to inject multiple times into the same tab.

if (typeof window.__notesFromAiExtract === "undefined") {
  function extractPageContent() {
    ...
    // Prefer <article> or <main> — they usually hold the core content.
    const primary =
    ...
    // Collect code blocks separately so whitespace isn't collapsed.
    const codeBlocks = [];
